...
import { ModeToggle } from "../header/toggle/Toggle";

const MainBanner = () => {
  return (
    
    <div className="relative isolate flex items-center gap-x-6 overflow-hidden bg-yellow-50 px-6 py-2.5 sm:px-3.5 sm:before:flex-1">
      Toggle<ModeToggle />
      <div
